...
def instance_contrastive_loss(z1, z2):
    ...
    loss = (logits[:, i, B + i - 1].mean() + logits[:, B + i, i].mean()) / 2  #0~31 31~62  32~63  0~31 [78,32] [78,32]  [19,32] [9,32]
    return loss
...
def temporal_contrastive_loss(z1, z2):
    ...
    loss = (logits[:, t, T + t - 1].mean() + logits[:, T + t, t].mean()) / 2  #[32,78]  [32,19]
    return loss
